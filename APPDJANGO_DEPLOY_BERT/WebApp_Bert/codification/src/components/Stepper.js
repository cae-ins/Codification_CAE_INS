...
const ColorlibStepIconRoot = styled('div')(({ theme, ownerState }) => ({
  ...
  ...(ownerState.active && {
    backgroundImage:
      'linear-gradient( 136deg, rgb(110, 242, 33) 0%, rgb(157, 233, 64) 50%, rgb(35, 78, 138) 100%)',
...
const steps = ['Uploader', 'Traitement', 'Télecharger'];
...
export default function CustomizedSteppers({progressionEtapes}) {
  return (
    <Stack sx={{ width: '100%', marginTop: '5px' }} spacing={4}>
      ...
      <Stepper alternativeLabel activeStep={progressionEtapes} connector={<ColorlibConnector />}>
        {steps.map((label) => (
          <Step key={label}>
